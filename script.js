const fragen = [
  ...
  { frage: "Wie heißt der KI-Chatbot von OpenAI?", antwort: "chatgpt" },
  { frage: "Wurde das Spiel Elden Ring vor 2023 veröffentlicht? (ja/nein)", antwort: "ja" },
  ...
  { frage: "Welche Konsole veröffentlichte Sony 2020?", antwort: "ps5" },
  ...
  { frage: "Wie heißt die Mutter von Elon Musks Kind X AE A-12?", antwort: "grimes" },
  { frage: "Wie nennt man künstliche Intelligenz auf Englisch?", antwort: "artificial intelligence" },
  { frage: "Welche Firma entwickelte Windows?", antwort: "microsoft" },
  { frage: "In welchem Jahr wurde ChatGPT öffentlich?", antwort: "2022" },
  { frage: "Wie nennt man digitale Währung?", antwort: "kryptowährung" },
  ...
  { frage: "Wie heißt die bekannteste Streamingplattform für Gamer?", antwort: "twitch" },
